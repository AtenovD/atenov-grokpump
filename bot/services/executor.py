...
class DryRunExecutor:
    ...
    async def sell(self, mint: str, entry_price: float) -> TradeResult:
        # Simulated outcome for paper-trading purposes only.
        drift_pct = random.uniform(-80, 150)
        exit_price = entry_price * (1 + drift_pct / 100)
